...
final class CalendarFeatureTests: XCTestCase {
    ...
    func testGoogleCalendarEventRequestEncoderIncludesBlockProfilePrivateProperties() throws {
        ...
        XCTAssertEqual(privateProperties["dahso.blockProfile.name"] as? String, "Deep Focus")
        XCTAssertEqual(privateProperties["dahso.blockProfile.identifier"] as? String, "deep-focus")
    }
    ...
    private func makeTemporaryWorkspace() throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("dahso-calendar-tests-\(UUID().uuidString)", isDirectory: true)
