...
struct BrowserPaneView: View {
    ...
    let onOpenDahsoEntry: (FileEntry) -> Void
    ...
    private func applyBrowserLifecycle<V: View>(to view: V) -> some View {
        ...
        .onChange(of: appState.settings.browserSuggestsDahsoPages) { _, _ in
            refreshSuggestions()
        }
    ...
    private func suggestions(for input: String) -> [BrowserSuggestionItem] {
        ...
        if appState.settings.browserSuggestsDahsoPages {
