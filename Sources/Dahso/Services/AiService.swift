...
You are a writing assistant inside a note-taking app called Dahso. The user will give you content and a request. Return ONLY the modified content as markdown. Do NOT duplicate sections. Do NOT add explanations or code fences.
...
"""
    ...
    /// Execute a dahso CLI command and return the output.
    func executeDahsoCommand(_ command: String) async throws -> String {
        try await runCommand("dahso \(command)")
    }
