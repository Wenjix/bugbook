...
struct BlockCellView: View {
    ...
    private var blockInteractionCursor: NSCursor {
        switch block.type {
        case .paragraph, .heading, .bulletListItem, .numberedListItem, .taskItem,
             .blockquote, .codeBlock, .toggle, .headingToggle, .callout, .footnote:
            return .iBeam
        default:
            return .arrow
        }
    ...
    private var blockContent: some View {
        ...
        case .footnote:
            FootnoteBlockView(document: document, block: block, onTyping: onTyping)
