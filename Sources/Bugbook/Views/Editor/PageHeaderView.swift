...
struct PageHeaderView: View {
    ...
    var fullWidth: Bool
    var contentColumnMaxWidth: CGFloat?
    ...
    var body: some View {
        ...
        .task(id: coverUrl) {
            ...
            cachedCoverImage = data.flatMap(NSImage.init(data:))
        }
    }
            ...
            ZStack(alignment: .topTrailing) {
                ...
                if isRepositioning {
                    coverRepositionOverlay(
                        containerSize: CGSize(width: geometry.size.width, height: coverHeight),
                        imageSize: imgSize
                    )
                }
    ...
    private func coverRepositionOverlay(containerSize: CGSize, imageSize: NSSize) -> some View {
        Rectangle()
            ...
            .contentShape(Rectangle())
            .gesture(coverRepositionGesture(containerSize: containerSize, imageSize: imageSize))
    }

    private func coverRepositionGesture(containerSize: CGSize, imageSize: NSSize) -> some Gesture {
        DragGesture(minimumDistance: 0)
            .onChanged { value in
                ...
                let maxOffset = max(1, coverOverflowHeight(containerSize: containerSize, imageSize: imageSize))
    ...
    private var coverActionControls: some View {
        HStack(spacing: 4) {
            ...
            Button(action: {
                ...
                Label(
                    ...
                    systemImage: isRepositioning ? "checkmark" : "arrow.up.and.down.and.arrow.left.and.right"
                )
                .font(.system(size: 12))
            }
            .buttonStyle(CoverActionButtonStyle())
