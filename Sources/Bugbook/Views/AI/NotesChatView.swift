...
struct NotesChatView: View {
    ...
    private func sendMessage() {
        ...
        fileReferenceSearch = ""
        SentryBreadcrumbs.add(Breadcrumb(level: .info, category: "ai.send"))
        ...
        Task {
            do {
                ...
                SentryBreadcrumbs.add(Breadcrumb(level: .info, category: "ai.receive"))
                ...
                SentryBreadcrumbs.add(Breadcrumb(level: .error, category: "ai.error"))
