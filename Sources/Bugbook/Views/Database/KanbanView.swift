...
struct KanbanView: View {
    ...
    var visibleRowsProvider: (() -> [DatabaseRow])?
    ...
    @State private var showColumnPopover: String?
    @State private var showCardPopover: String?
    ...
    @State private var dragTargetColumn: String?
...
private extension KanbanView {
    ...
    private func addCardInColumn(_ columnId: String) {
        ...
        let rowIDCharacters = Array("abcdefghijklmnopqrstuvwxyz0123456789")
        let suffix = String((0..<6).map { _ in rowIDCharacters.randomElement() ?? "a" })
