...
struct Page: ParsableCommand {
    ...
    struct Get: ParsableCommand {
        ...
        @Flag(name: .long, help: "Include internal Dahso markdown comments such as persisted block IDs")
    ...
    struct Format: ParsableCommand {
        ...
        @Option(name: .long, help: "Formatting style: dahso or commonmark")
        var style: PageMarkdownFormatStyle = .dahso
    ...
    struct Compact: ParsableCommand {
        static let configuration = CommandConfiguration(
            commandName: "compact",
            abstract: "Rewrite a markdown page using Dahso's compact block formatting"
        )
