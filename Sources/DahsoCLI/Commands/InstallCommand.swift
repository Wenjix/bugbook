...
enum DahsoBinaryInstallMethod: String {
    case symlink
    case copy
}

func installDahsoBinary(
    sourcePath: String,
    destinationDirectory: String,
    installedName: String,
    method: DahsoBinaryInstallMethod,
    force: Bool
) throws -> [String: Any] {
...
struct Install: ParsableCommand {
    static let configuration = CommandConfiguration(
        commandName: "install",
        abstract: "Install the current DahsoCLI binary as `dahso`"
    )
